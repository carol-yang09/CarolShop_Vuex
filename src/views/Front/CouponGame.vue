...
export default {
  ...
  methods: {
    ...
    roateTurntable(deg, n) {
      ...
      if (n === 7) {
        vm.prize = vm.coupon[1];
      } else if (n === 5) {
        vm.prize = vm.coupon[4];
      } else if (n === 3) {
        vm.prize = vm.coupon[3];
      } else if (n === 1) {
        vm.prize = vm.coupon[2];
      } else {
        vm.prize = vm.coupon[0];
      }
      setTimeout(() => {
...
.coupon-turntable-bg {
  ...
  margin: 0 auto;
  position: relative;
  background: url('../../../static/image/game-large.png') center center no-repeat;
  cursor: pointer;
  @media (max-width: 767px) {
    width: 260px;
    height: 260px;
    margin-bottom: 1rem;
    background: url('../../../static/image/game-small.png') center center no-repeat;
  }
}
.coupon-turntable-arrow {
  ...
  left: 203px;
  right: 0;
  background: url('../../../static/image/arrow-large.png') center center no-repeat;
  ...
  @media (max-width: 767px) {
    ...
    top: 94px;
    left: 95px;
    background: url('../../../static/image/arrow-small.png') center center no-repeat;
...
.modal-bg {
  ...
  height: 512px;
  width: 512px;
  background: url('../../../static/image/envelope-big.png') center center no-repeat;
  @media (max-width: 767px) {
    width: 320px;
    height: 320px;
    background: url('../../../static/image/envelope-small.png') center center no-repeat;
  }
}
@media (max-width: 767px) {
  .model-text {
